...
class MoviePreviewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // print("printing trailers")
        //print(trailers)
        // print("done printing trailers")
        //let myURL = URL(string: "https://www.youtube.com/watch?v=" + (trailers["key"] as! String))
        //let myRequest = URLRequest(url: myURL!)
        //moviePreview.load(myRequest)
    }
